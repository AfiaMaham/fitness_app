...
import 'package:gofit_fitness_and_workout_app/views/screens/forgot_password_screen.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          ).paddingSymmetric(horizontal: 10.w, vertical: 4.5.h),
          Padding(
          ...
          ContainerButton(text: "Sign in",onButtonTap: (){
          ...
          GestureDetector(
            ...
            ).paddingSymmetric(vertical: 2.5.h),
          ),
          Row(
            children: [
